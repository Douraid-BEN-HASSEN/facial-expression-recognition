"""
🎯 SCRIPT DE PRÉDICTION AVEC MODÈLE TRANSFORMER
================================================

Script pour faire des prédictions d'émotions avec un modèle Transformer entraîné.

UTILISATION :
------------
# Prédiction sur une seule image
python scripts/predict_transformer_script.py \
    --model_path ./models/emotion_transformer/emotion_transformer.pth \
...
from classes.EmotionTransformerModel import ModelManager, predict_emotion_transformer
...
def predict_single_image(
    ...
    """
    print("\n" + "="*80)
    print("🎯 PRÉDICTION D'ÉMOTION AVEC TRANSFORMER")
    print("="*80)
    ...
    result = predict_emotion_transformer(
...
def predict_batch(
    ...
    """
    print("\n" + "="*80)
    print("🎯 PRÉDICTION PAR LOT AVEC TRANSFORMER")
    print("="*80)
    ...
    if save_results:
        if output_path is None:
            output_path = image_dir / "predictions_transformer.json"
...
def evaluate_on_test_set(
    ...
    """
    Évaluer le modèle sur un ensemble de test organisé par émotions
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Prédiction d'émotions avec modèle Transformer",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Exemples d'utilisation :
------------------------
# Prédiction sur une image unique
python scripts/predict_transformer_script.py --model_path ./models/emotion_transformer/emotion_transformer.pth --image_path ./test.jpg --show_image

# Prédiction sur un dossier d'images
python scripts/predict_transformer_script.py --model_path ./models/emotion_transformer/emotion_transformer.pth --image_dir ./test_images/ --save_results

# Évaluation sur un test set organisé par émotions
python scripts/predict_transformer_script.py --model_path ./models/emotion_transformer/emotion_transformer.pth --test_dir ./datasets/fer2013/test/
        """
    )
    parser.add_argument("--model_path", type=str, default='./models/emotion_features_transformer/emotion_features_transformer.pth',
    ...
    parser.add_argument("--face_part", type=str, default="full_face",
                       ...
                       help="Partie du visage à utiliser (défaut: eyes_mouth)")
